...
const Home = (props) => {
    ...
    useEffect(() => {
        ...
        Meteor.call('Esmeralda_plates', (error, elements) => setPlates(elements))
    }, [])
    ...
    const handleOnClickAddBtn = () => {
        ...
        if (inputPickerVehicles && datePickerStart && datePickerEnd && inputPickerFuel && inputNumberGallons && inputNumberUnitaryPrice && inputNumberSalesValue && inputNumberTotalPrice && inputNumberJoker) {
            Meteor.call('Esmeralda_queryVehicleForDates',
                inputPickerVehicles,
        ...
        <Container className="flex-column-space-between">
            <Header>
                <Navbar appearance="inverse">
                    <Navbar.Header>
                        <img src="/img/sile.jpg" alt="Esmeralda Logo" height="45" className="navbar-brand" />
                    </Navbar.Header>
                    <Navbar.Body>
                        <Nav>
                            <Nav.Item>
